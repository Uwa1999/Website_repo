...
//   const ArticleDescMainv2({Key? key}) : super(key: key);
//
//   @override
...
class _ArticleDescMainv2State extends State<ArticleDescMainv2> {
  ...
  void _scrollListener() {
    ...
    // You can adjust the threshold here if you want to show FAB earlier
    ...
    return Scaffold(
      ...
      floatingActionButton: Visibility(
        ...
        child: FloatingActionButton(
          backgroundColor: AppColors.maroon08,
          child: Icon(
            Icons.expand_less, // Changed from expand_more to expand_less
            size: Sizes.ICON_SIZE_18,
            color: AppColors.white,
          ),
