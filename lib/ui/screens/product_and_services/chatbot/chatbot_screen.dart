...
class ChatbotDescScreen extends StatefulWidget {
  const ChatbotDescScreen({Key? key}) : super(key: key);

  @override
  State<ChatbotDescScreen> createState() => _ChatbotDescScreenState();
}

class _ChatbotDescScreenState extends State<ChatbotDescScreen> {
  @override
