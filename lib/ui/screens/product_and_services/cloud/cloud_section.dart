...
class CloudSection extends StatefulWidget {
  const CloudSection({Key? key}) : super(key: key);

  @override
  State<CloudSection> createState() => _CloudSectionState();
}

class _CloudSectionState extends State<CloudSection> with SingleTickerProviderStateMixin {
  ...
  Widget _buildNimbusInfoSectionSm() {
    return NimbusInfoSection2(
      title1: StringConst.CLOUD_TEST_ENVIRONMENT_TITLE,
      hasTitle2: false,
      body: StringConst.CLOUD_TEST_ENVIRONMENT_DESC,
      child: Column(
        children: [],
      ),
    );
