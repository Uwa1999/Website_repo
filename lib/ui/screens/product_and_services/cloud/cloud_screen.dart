...
class CloudDescScreen extends StatefulWidget {
  const CloudDescScreen({Key? key}) : super(key: key);

  @override
  State<CloudDescScreen> createState() => _CloudDescScreenState();
}

class _CloudDescScreenState extends State<CloudDescScreen> {
  @override
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBoxH70(),
              Text(
                StringConst.CLOUD_TEST_ENVIRONMENT_TITLE,
                style: titleStyle,
              ),
            ],
          ),
