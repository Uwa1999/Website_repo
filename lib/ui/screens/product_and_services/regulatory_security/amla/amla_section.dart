...
class AmlaSection extends StatefulWidget {
  const AmlaSection({Key? key}) : super(key: key);

  @override
  State<AmlaSection> createState() => _AmlaSectionState();
}

class _AmlaSectionState extends State<AmlaSection> {
  @override
  ...
  Widget _buildAmlaGIF({required double width, required double height}) {
    return Stack(
      children: [
        Image.asset(
          ImagePath.AML_GIF,
            ...
            children: [
              Padding(
                ...
                child: NimbusInfoSection1(
                  title1: StringConst.AML_TITLE,
                  hasTitle2: false,
                  body: StringConst.AML_DESC,
