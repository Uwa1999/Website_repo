...
class AmlaDescScreen extends StatefulWidget {
  const AmlaDescScreen({Key? key}) : super(key: key);

  @override
  State<AmlaDescScreen> createState() => _AmlaDescScreenState();
}

class _AmlaDescScreenState extends State<AmlaDescScreen> {
  @override
