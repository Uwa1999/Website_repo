...
class FraudDetectionSection extends StatefulWidget {
  const FraudDetectionSection({Key? key}) : super(key: key);

  @override
  State<FraudDetectionSection> createState() => _FraudDetectionSectionState();
}

class _FraudDetectionSectionState extends State<FraudDetectionSection> {
  @override
  ...
  Widget _buildFraudDecGIF({required double width, required double height}) {
    return Stack(
      children: [
        Image.asset(
          ImagePath.FRAUD_DETECTION_GIF,
          width: width * 0.70,
        ),
      ],
    );
