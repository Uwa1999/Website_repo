...
class FraudDetectionDescScreen extends StatefulWidget {
  const FraudDetectionDescScreen({Key? key}) : super(key: key);

  @override
  State<FraudDetectionDescScreen> createState() => _FraudDetectionDescScreenState();
}

class _FraudDetectionDescScreenState extends State<FraudDetectionDescScreen> {
  @override
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBoxH70(),
              Text(
                StringConst.FRAUD_DETECTION_TITLE,
                style: titleStyle,
              ),
            ],
          ),
