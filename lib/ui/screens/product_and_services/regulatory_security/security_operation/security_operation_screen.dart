...
class SecurityOperationDecsScreen extends StatefulWidget {
  const SecurityOperationDecsScreen({Key? key}) : super(key: key);

  @override
  State<SecurityOperationDecsScreen> createState() => _SecurityOperationDecsScreenState();
}

class _SecurityOperationDecsScreenState extends State<SecurityOperationDecsScreen> {
  @override
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBoxH70(),
              Text(
                StringConst.SECURITY_OPERATION_TITLE,
                style: titleStyle,
              ),
            ],
          ),
