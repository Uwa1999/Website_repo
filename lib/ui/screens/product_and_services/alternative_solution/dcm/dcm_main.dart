...
import 'package:FDS_ASYA_PHILIPPINES/ui/screens/product_and_services/banking_technology/dcm/dcm_section.dart';
...
class DcmDescMain extends StatefulWidget {
  const DcmDescMain({Key? key}) : super(key: key);

  @override
  State<DcmDescMain> createState() => _DcmDescMainState();
}

class _DcmDescMainState extends State<DcmDescMain> with SingleTickerProviderStateMixin {
