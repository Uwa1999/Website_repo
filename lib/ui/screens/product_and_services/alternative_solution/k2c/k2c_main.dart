...
import 'package:FDS_ASYA_PHILIPPINES/ui/screens/product_and_services/banking_technology/k2c/k2c_section.dart';
...
class K2cDescMain extends StatefulWidget {
  const K2cDescMain({Key? key}) : super(key: key);

  @override
  State<K2cDescMain> createState() => _K2cDescMainState();
}

class _K2cDescMainState extends State<K2cDescMain> with SingleTickerProviderStateMixin {
