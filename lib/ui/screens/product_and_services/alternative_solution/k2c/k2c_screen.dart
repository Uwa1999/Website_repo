...
class K2cDescScreen extends StatefulWidget {
  const K2cDescScreen({Key? key}) : super(key: key);

  @override
  State<K2cDescScreen> createState() => _K2cDescScreenState();
}

class _K2cDescScreenState extends State<K2cDescScreen> with SingleTickerProviderStateMixin {
  @override
