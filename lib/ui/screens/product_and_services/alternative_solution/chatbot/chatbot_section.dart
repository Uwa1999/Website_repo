...
class ChatbotSection extends StatefulWidget {
  const ChatbotSection({Key? key}) : super(key: key);
...
class _ChatbotSectionState extends State<ChatbotSection> {
  ...
  Widget _buildChatbotGIF({required double width, required double height}) {
    return Stack(
      children: [
        Image.asset(
