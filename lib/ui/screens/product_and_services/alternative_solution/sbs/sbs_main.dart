...
import 'package:FDS_ASYA_PHILIPPINES/ui/screens/product_and_services/banking_technology/sbs/sbs_section.dart';
...
class SbsDescMain extends StatefulWidget {
  const SbsDescMain({Key? key}) : super(key: key);

  @override
  State<SbsDescMain> createState() => _SbsDescMainState();
}

class _SbsDescMainState extends State<SbsDescMain> with SingleTickerProviderStateMixin {
