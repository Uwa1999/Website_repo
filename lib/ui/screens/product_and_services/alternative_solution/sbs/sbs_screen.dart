...
class SbsDescScreen extends StatefulWidget {
  const SbsDescScreen({Key? key}) : super(key: key);

  @override
  State<SbsDescScreen> createState() => _SbsDescScreenState();
}

class _SbsDescScreenState extends State<SbsDescScreen> {
  @override
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBoxH70(),
              Text(
                StringConst.SMART_BRANCH_SYSTEM_TITLE,
                style: titleStyle,
              ),
            ],
          ),
