...
class MinokawaSection extends StatefulWidget {
  const MinokawaSection({Key? key}) : super(key: key);

  @override
  State<MinokawaSection> createState() => _MinokawaSectionState();
}

class _MinokawaSectionState extends State<MinokawaSection> {
  @override
  ...
  Widget _buildMinokawaGIF({required double width, required double height}) {
    return Stack(
      children: [
        Image.asset(
          ImagePath.MINOKAWA_GIF,
          width: width * 0.70,
        ),
      ],
    );
            ...
            children: [
              Padding(
                ...
                child: NimbusInfoSection1(
                  title1: StringConst.MINOKAWA_TITLE,
                  hasTitle2: false,
                  body: StringConst.MINOKAWA_DESC,
