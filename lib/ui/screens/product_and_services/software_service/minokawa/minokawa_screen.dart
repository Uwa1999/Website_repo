...
class MinokawaDecsScreen extends StatefulWidget {
  const MinokawaDecsScreen({Key? key}) : super(key: key);

  @override
  State<MinokawaDecsScreen> createState() => _MinokawaDecsScreenState();
}

class _MinokawaDecsScreenState extends State<MinokawaDecsScreen> {
  @override
