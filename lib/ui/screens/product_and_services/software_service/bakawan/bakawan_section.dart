...
class BakawanSection extends StatefulWidget {
  const BakawanSection({Key? key}) : super(key: key);

  @override
  State<BakawanSection> createState() => _BakawanSectionState();
}

class _BakawanSectionState extends State<BakawanSection> {
  @override
  ...
  Widget _buildBakawanGIF({required double width, required double height}) {
    return Stack(
      children: [
        Image.asset(
          ImagePath.BAKAWAN_GIF,
          width: width * 0.70,
        ),
      ],
    );
            ...
            children: [
              Padding(
                ...
                child: NimbusInfoSection1(
                  title1: StringConst.BAKAWAN_TITLE,
                  hasTitle2: false,
                  body: StringConst.BAKAWAN_DESC,
