...
class BakawanDescScreen extends StatefulWidget {
  const BakawanDescScreen({Key? key}) : super(key: key);

  @override
  State<BakawanDescScreen> createState() => _BakawanDescScreenState();
}

class _BakawanDescScreenState extends State<BakawanDescScreen> {
  @override
