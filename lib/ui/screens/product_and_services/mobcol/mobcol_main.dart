import 'package:FDS_ASYA_PHILIPPINES/ui/screens/product_and_services/mobcol/mobcol_section.dart';
...
class MobColDescMain extends StatefulWidget {
  const MobColDescMain({Key? key}) : super(key: key);

  @override
  State<MobColDescMain> createState() => _MobColDescMainState();
}

class _MobColDescMainState extends State<MobColDescMain>with SingleTickerProviderStateMixin {
