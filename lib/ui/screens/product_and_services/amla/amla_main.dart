...
import 'package:FDS_ASYA_PHILIPPINES/ui/screens/product_and_services/amla/amla_section.dart';
...
class AmlaDescMain extends StatefulWidget {
  const AmlaDescMain({Key? key}) : super(key: key);

  @override
  State<AmlaDescMain> createState() => _AmlaDescMainState();
}

class _AmlaDescMainState extends State<AmlaDescMain> with SingleTickerProviderStateMixin {
