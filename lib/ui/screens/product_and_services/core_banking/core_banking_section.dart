...
class CoreBankingSection extends StatefulWidget {
  const CoreBankingSection({Key? key}) : super(key: key);

  @override
  State<CoreBankingSection> createState() => _CoreBankingSectionState();
}

class _CoreBankingSectionState extends State<CoreBankingSection> with SingleTickerProviderStateMixin {
  ...
  Widget _buildNimbusInfoSectionSm() {
    return NimbusInfoSection2(
      ...
      hasTitle2: false,
      body: StringConst.CORE_BANKING_DESC,
      child: Column(
        children: [],
      ),
    );
