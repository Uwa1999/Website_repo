...
class CoreBankingDescScreen extends StatefulWidget {
  const CoreBankingDescScreen({Key? key}) : super(key: key);

  @override
  State<CoreBankingDescScreen> createState() => _CoreBankingDescScreenState();
}

class _CoreBankingDescScreenState extends State<CoreBankingDescScreen> {
  @override
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBoxH70(),
              Text(
                StringConst.CORE_BANKING_TITLE,
                style: titleStyle,
              ),
            ],
          ),
