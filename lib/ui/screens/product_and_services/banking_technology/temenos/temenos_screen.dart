...
class TemenosDescScreen extends StatefulWidget {
  const TemenosDescScreen({Key? key}) : super(key: key);

  @override
  State<TemenosDescScreen> createState() => _TemenosDescScreenState();
}

class _TemenosDescScreenState extends State<TemenosDescScreen> {
  @override
